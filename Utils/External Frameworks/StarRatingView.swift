...
class StarRatingView: UIView {
    ...
    private func updateLocation(_ location: CGPoint, _ isFinalValue: Bool = true) {
        switch self.type {
        case .rate:
            ...
            self.current = count
            delegate?.StarRatingValueChanged(view: self, value: count, isFinalValue: isFinalValue)
        ...
        case .half:
            ...
            delegate?.StarRatingValueChanged(view: self, value: self.current, isFinalValue: isFinalValue)
